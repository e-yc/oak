...
const sections: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Oak.',
      'Windows: Defender Firewall → Allow app — enable Oak for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Oak must be open on your desktop to accept connections.',
      'Try restarting Oak — the companion server starts on launch.',
