...
const RELEASES_URL = 'https://github.com/e-yc/oak/releases'
const IOS_APP_STORE_URL = 'itms-apps://apps.apple.com/app/oak-ide/id6766130217'
...
export function ProtocolBlockScreen({ verdict }: Props) {
  ...
  const title = isMobileTooOld ? 'Update Oak Mobile' : 'Update Oak on your computer'
  const body = isMobileTooOld
    ? `This desktop needs a newer Oak Mobile app. Update Oak Mobile from ${mobileUpdateTarget.storeName}, then try this host again.`
    : 'This paired desktop app is too old for your current Oak Mobile app. Update Oak on your computer, then try this host again.'
  const recoveryNote =
