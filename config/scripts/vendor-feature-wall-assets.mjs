...
const DEFAULT_MARKETING_REPO = path.join(
  ...
  'repos',
  'Stably',
  'oak-marketing-website'
)
const MARKETING_REPO = process.env.OAK_MARKETING_REPO || DEFAULT_MARKETING_REPO
...
const TILES = [
  ...
  {
    id: 'tile-03',
    gifRelativePath: 'public/whats-new/oak-github.gif',
    posterRelativePath: 'public/whats-new/posters/oak-github.jpg'
  },
  {
    id: 'tile-04',
  ...
  {
    id: 'tile-05',
    gifRelativePath: 'public/whats-new/oak-design-mode.gif',
    posterRelativePath: 'public/whats-new/posters/oak-design-mode.jpg'
  },
  {
    id: 'tile-06',
  ...
  {
    id: 'tile-09',
    gifRelativePath: 'public/whats-new/oak-cli-demo.gif',
    posterRelativePath: 'public/whats-new/posters/oak-cli-demo.jpg'
  },
  {
    id: 'tile-10',
  ...
  {
    id: 'tile-12',
    gifRelativePath: 'public/whats-new/oak-markdown-editor.gif',
    posterRelativePath: 'public/whats-new/posters/oak-markdown-editor.jpg'
  }
]
