...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /シャチ:\/\//g, replacement: 'oak://', whenEnIncludes: 'oak://' },
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Oak' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Oak' },
