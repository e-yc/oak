...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /虎鲸:\/\//g, replacement: 'oak://', whenEnIncludes: 'oak://' },
    ...
    { pattern: /连接到Oak/g, replacement: '连接到 Oak', whenEnIncludes: 'Connect to Oak' },
    {
      pattern: /开始使用Oak/g,
      replacement: '开始使用 Oak',
      whenEnIncludes: 'get started with Oak'
    },
