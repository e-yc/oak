...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without an Oak scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Oak scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without an Oak scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Oak scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without an Oak scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
