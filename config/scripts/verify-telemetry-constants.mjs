...
// Asserts that the telemetry compile-time constants — `OAK_BUILD_IDENTITY`
// and `OAK_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Oak.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Oak.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `OAK_BUILD_IDENTITY` and `OAK_POSTHOG_WRITE_KEY` with their
