...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Oak IDE': 'Oak IDE',
  'Oak first': 'Oak 优先',
  'Oak Mobile': 'Oak Mobile',
  'Oak logo': 'Oak 标志',
  'Enjoying Oak?': '喜欢 Oak 吗？',
  'Get to know Oak': '了解 Oak',
  'Expand Oak': '展开 Oak',
  'Support Oak': '支持 Oak',
  'Restarting Oak…': '正在重启 Oak…',
  'Oak Attribution': 'Oak 归因',
  'Show Oak Mobile Button': '显示 Oak Mobile 按钮',
  ...
  "Give agents direct access to Oak's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Oak 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Oak. It is still on your disk.': '来自 Oak。它仍保留在您的磁盘上。',
