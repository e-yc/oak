...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__oak_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__oakBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-oak-browser-annotation-overlay';
  const markerSize = 24;
