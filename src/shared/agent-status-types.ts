...
// These types define the normalized status that Oak receives from Claude,
...
export type AgentStateHistoryEntry = {
   ...
   *  (for example Claude Code `is_interrupt`) or Oak's guarded interrupt
...
export type AgentStatusEntry = {
   ...
   *  inferred by Oak's guarded interrupt fallback.
   ...
   *  Used only for exact CLI resume; Oak terminal ids are not agent-session ids. */
