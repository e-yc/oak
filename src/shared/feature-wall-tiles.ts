...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    caption:
      'Run agents on a remote machine with the same Oak editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
  ...
  },
  {
    ...
    kind: 'media',
    title: 'Oak CLI',
    caption: 'Agents can drive Oak too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
