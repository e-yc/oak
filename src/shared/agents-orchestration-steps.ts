// Per-step copy for the agents-orchestration tile in the Explore Oak modal.
...
export const AGENTS_STEPS: readonly AgentsStep[] = [
  ...
  },
  {
    ...
    description: 'Enable agents to manage and coordinate Oak workspaces to execute larger tasks.'
  },
  {
    id: 'usage',
    name: 'Usage',
