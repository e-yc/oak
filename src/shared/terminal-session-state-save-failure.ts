export const TERMINAL_SESSION_STATE_SAVE_FAILED_CODE = 'OAK_TERMINAL_SESSION_STATE_SAVE_FAILED'

export const TERMINAL_SESSION_STATE_SAVE_FAILED_MESSAGE =
  'Oak could not save this terminal session because local storage is unavailable.'
