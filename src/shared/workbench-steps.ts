// Per-step copy for the workbench tile in the Explore Oak modal. Mirrors
...
export const WORKBENCH_STEPS: readonly WorkbenchStep[] = [
  ...
  },
  {
    ...
    name: 'Editor',
    subtitle: 'Editor',
    description: 'Use our Notion-style markdown editor to write notes without leaving Oak.'
  },
  {
    id: 'browser',
    name: 'Browser',
