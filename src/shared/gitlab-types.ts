...
// target_type narrows to the four shapes Oak renders meaningfully —
...
// tab so users can see which job failed and where without leaving Oak.
...
export type GitLabWorkItemDetails = {
   ...
   *  picker) — main-process doesn't know Oak's Repo.id. */
