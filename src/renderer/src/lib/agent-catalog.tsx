...
export const getAgentCatalog = createLocalizedCatalog((): AgentCatalogEntry[] => [
  ...
  },
  {
    ...
    cmd: 'openclaude',
    // Why: OpenClaude's published favicon has a padded 500px canvas; Oak
  ...
  },
  {
    ...
    // the settings pane's "default command" hint aligns with what Oak
  ...
  },
  {
    ...
    // suggestion that Oak is looking for Windows' built-in `cmd.exe`.
    cmd: 'command-code',
