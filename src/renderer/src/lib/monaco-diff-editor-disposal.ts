...
type GuardedDiffEditor = editor.IStandaloneDiffEditor & {
  __oakDiffEditorDisposeGuardInstalled?: true
}

type GuardedEditorNamespace = MonacoDiffEditorNamespace['editor'] & {
  __oakDiffEditorFactoryGuardInstalled?: true
}
...
export function guardMonacoDiffEditorDispose(
  ...
  if (guardedDiffEditor.__oakDiffEditorDisposeGuardInstalled) {
    return diffEditor
  }
  ...
  guardedDiffEditor.__oakDiffEditorDisposeGuardInstalled = true
...
export function installMonacoDiffEditorDisposalGuard(
  ...
  if (editorNamespace.__oakDiffEditorFactoryGuardInstalled) {
    return
  }
  ...
  editorNamespace.__oakDiffEditorFactoryGuardInstalled = true
}
