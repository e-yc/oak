...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __oakDelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__oakDelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__oakDelayerCancellationGuardInstalled = true
}
