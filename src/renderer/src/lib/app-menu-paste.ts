...
export const APP_MENU_PASTE_EVENT = 'oak-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Oak already resolved.
  ...
  // Why: for text controls Oak has already resolved ownership. Falling back
