...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'oak:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'oak:emulator-launch-failed'
