export const ORCHESTRATION_SETUP_STATE_EVENT = 'oak:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'oak.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'oak.orchestration.setupDismissed'
