...
describe('isWorkItemLookupText', () => {
  it('detects GitHub PR and issue URLs', () => {
    expect(isWorkItemLookupText('https://github.com/e-yc/oak/pull/4900')).toBe(true)
    expect(isWorkItemLookupText('https://github.com/e-yc/oak/issues/123')).toBe(true)
    expect(isWorkItemLookupText('  https://www.github.com/e-yc/oak/pull/1 ')).toBe(true)
  })
