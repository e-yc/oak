export const OAK_TERMINAL_COMMAND_FINISHED_EVENT = 'oak:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(worktreeId: string): void {
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(OAK_TERMINAL_COMMAND_FINISHED_EVENT, {
      detail: { worktreeId }
    })
  )
}
