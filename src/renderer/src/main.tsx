...
function RendererRoot(): React.JSX.Element {
  ...
  return (
    <RecoverableRenderErrorBoundary
      boundaryId="app.root"
      surface="app-root"
      title={translate('app.recoverableError.rootTitle', 'Oak hit a renderer error.')}
      description={translate(
        'app.recoverableError.rootDescription',
        'The app shell could not finish rendering. Retry to remount it, or relaunch Oak if the error persists.'
      )}
    >
      <App />
    </RecoverableRenderErrorBoundary>
