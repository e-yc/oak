...
const sections: SettingsNavSection[] = [
  {
    ...
    searchEntries: [
      {
        title: 'Oak CLI',
        description: 'Register or remove the oak shell command.',
  ...
  {
    id: 'servers',
    title: 'Remote Oak Servers',
    description: 'Pair remote Oak runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote Oak Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
