      ...
      <div className="space-y-2.5">
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect a review provider so Oak can show PR or MR status, checks, and reviews.'
          )}
          summary={
            <>
        ...
        <IntegrationStep
          ...
          title={translate(
            ...
            'Start agents on your tasks without leaving Oak'
          )}
          description={translate(
            'auto.components.feature.wall.ConnectIntegrationsList.33b650af52',
            'Connect where your team tracks work. Oak starts workspaces with the issue title, link, and context already attached.'
          )}
          summary={
