...
import { OAK_CLI_SKILL_NAME, ORCHESTRATION_SKILL_NAME } from '@/lib/agent-feature-install-commands'
import {
...
export function FeatureWallTourSurface({
  ...
  panelClassName,
  doneLabel = 'Done',
  footerText = 'Reopen any time from Help > Explore Oak.',
  ...
  const browserUseSkill = useInstalledAgentSkill(OAK_CLI_SKILL_NAME, {
    enabled: isOpen,
    discoveryTarget: activeSkillRuntime.discoveryTarget,
    sourceKinds: GLOBAL_AGENT_SKILL_SOURCE_KINDS
  })
