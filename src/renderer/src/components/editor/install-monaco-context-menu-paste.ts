...
import {
  OAK_CONTEXT_MENU_PASTE_NAME,
  OAK_CONTEXT_MENU_PASTE_PRIORITY,
  runOakContextMenuPaste
 ...
 * Oak's trusted IPC bridge instead of the sandbox-blocked navigator.clipboard.
...
export function installMonacoContextMenuPaste(monaco: typeof Monaco): void {
  ...
  PasteAction.addImplementation(OAK_CONTEXT_MENU_PASTE_PRIORITY, OAK_CONTEXT_MENU_PASTE_NAME, () =>
    runOakContextMenuPaste({
      getFocusedEditor: () =>
