...
describe('doc link hrefs', () => {
  it('round-trips encoded targets', () => {
    ...
    expect(href).toBe('#oak-doc-link=docs%2Fsetup%20guide')
...
describe('remarkMarkdownDocLinks', () => {
  it('runs as a react-markdown remark plugin', () => {
    ...
    expect(html).toContain('<a href="#oak-doc-link=other.md">other.md</a>')
  ...
  it('renders aliased doc links with the alias text', () => {
    ...
    expect(html).toContain('<a href="#oak-doc-link=other.md">Other note</a>')
