      ...
      <div className="flex items-center">
        ...
        <div className="flex-1 min-w-0 py-2 pr-3 flex items-center justify-between">
          <span className="text-[11px] font-semibold uppercase tracking-wide truncate text-muted-foreground">
            {translate('auto.components.status.bar.ResourceUsageStatusSegment.288a4dd177', 'Oak')}
          </span>
          <div className="flex items-center gap-2 shrink-0">
...
export function ResourceUsageStatusSegment({
  ...
  const handleKillSession = useCallback(
    (session: UnifiedSessionRow): void => {
      // Why: orphan sessions have no tab in this Oak instance, so there's
              ...
              <Tooltip delayDuration={200}>
                ...
                <TooltipContent side="top" sideOffset={6} className="z-[70] max-w-xs">
                  {translate(
                    ...
                    "Resident memory held by Oak plus the processes under each worktree's terminals."
                  )}
                </TooltipContent>
              </Tooltip>
              <span className="text-muted-foreground/50">·</span>
              <Tooltip delayDuration={200}>
                ...
                <TooltipContent side="top" sideOffset={6} className="z-[70] max-w-xs">
                  {translate(
                    ...
                    "How much of this machine's physical RAM the Oak-tracked processes are sitting on."
                  )}
                </TooltipContent>
              </Tooltip>
            </div>
