...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Oak Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Oak Mobile')
  })

  it('labels the restore action explicitly when Oak Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
