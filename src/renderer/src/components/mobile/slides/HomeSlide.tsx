      ...
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          ...
          <span className="mp-app-brand-name">
            {translate('auto.components.mobile.slides.HomeSlide.5d94e8ddcc', 'Oak')}
          </span>
        </div>
        <button
          type="button"
...
function OakLogo(): React.JSX.Element {
  return (
    <svg className="mp-oak-logo" viewBox="0 0 318.60232 202.66667" fill="currentColor" aria-hidden>
