...
vi.mock('@/hooks/useVirtualizedScrollAnchor', () => ({
  VIRTUALIZED_SCROLL_ANCHOR_RECORD_EVENT: 'oak:test-record-scroll-anchor',
...
vi.mock('./WorktreeCardAgents', () => ({
  ...
  SUPPRESS_WORKTREE_LIST_SCROLL_ADJUSTMENT_EVENT: 'oak:test-suppress-scroll-adjustment'
}))
...
function makeHostedReview(overrides: Partial<HostedReviewInfo> = {}): HostedReviewInfo {
  return {
    ...
    state: 'open',
    url: 'https://gitlab.com/acme/oak/-/merge_requests/42',
    status: 'success',
