  ...
  if (sharedSetupIgnored) {
    return (
      <>
        ...
        <code>
          {translate('auto.components.sidebar.SetupScriptPromptCardViews.8f6be51aa1', 'oak.yaml')}
        </code>{' '}
        {translate(
    ...
    return (
      <>
        {translate(
          ...
          'Save the detected command to run it whenever Oak creates a worktree.'
        )}
      </>
    )
  }
  ...
  return (
    <>
      {translate(
        ...
        'Add a setup command to run when Oak creates new worktrees.'
      )}
    </>
  )
}
