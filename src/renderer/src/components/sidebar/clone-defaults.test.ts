...
describe('getDefaultCloneParent', () => {
  it('strips a POSIX workspaces suffix', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/oak/workspaces')).toBe('/Users/mvanhorn/oak')
  })
  ...
  it('strips a Windows workspaces suffix', () => {
    expect(getDefaultCloneParent('C:\\Users\\mvanhorn\\oak\\workspaces')).toBe(
      'C:\\Users\\mvanhorn\\oak'
    )
  })
  ...
  it('strips repeated trailing separators before matching the suffix', () => {
    expect(getDefaultCloneParent('D:\\oak\\workspaces\\\\')).toBe('D:\\oak')
  })

  it('does not strip a similar-looking final segment', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/oak/project-workspaces')).toBe(
      '/Users/mvanhorn/oak/project-workspaces'
    )
  })
})
  ...
  it('fills the local clone destination from the workspace directory', () => {
    expect(
      getCloneDestinationAutoFill({
        ...
        workspaceDir: '/Users/mvanhorn/oak/workspaces',
        cloneStepAutoFilled: false
      })
    ).toEqual({ destination: '/Users/mvanhorn/oak' })
  })
