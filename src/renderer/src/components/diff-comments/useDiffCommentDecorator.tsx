...
export function useDiffCommentDecorator({
  ...
  useEffect(() => {
    ...
    plus.type = 'button'
    plus.className = 'oak-diff-comment-add-btn'
      ...
      rangeDecorationIds = editor.deltaDecorations(rangeDecorationIds, [
        {
          ...
          options: {
            isWholeLine: true,
            className: 'oak-diff-comment-range-highlight'
          }
        }
      ])
    }
  ...
  useEffect(() => {
            ...
            headerActions={
              worktreeId && comment.author === undefined ? (
                <NotesSendMenu
                  ...
                  triggerClassName="oak-diff-comment-edit"
    ...
    editor.changeViewZones((accessor) => {
      ...
      for (const c of relevant) {
        ...
        dom.className = 'oak-diff-comment-inline'
