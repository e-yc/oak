...
const FEATURE_SETUP_ROWS: readonly FeatureSetupRow[] = [
  {
    ...
    setupSummary: 'Enables browser use, prepares oak-cli, and leaves cookies for Settings.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the Oak CLI, opens permissions, and prepares the skill.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the Oak CLI, enables orchestration, and prepares the skill.',
