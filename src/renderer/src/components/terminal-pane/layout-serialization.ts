...
// "attach to a still-running TUI" — but Oak restores scrollback against a
...
// font gives Oak a known-good fallback even on clean systems, while the
...
const FALLBACK_FONTS = [
  ...
  'Oak Nerd Font Symbols', // bundled PUA fallback for OMP/Powerline glyphs
