...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--oak-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--oak-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--oak-terminal-overlay-probe width)')
