...
const updateCapableCallers = new Map<string, readonly string[]>([
  ...
  [
    ...
    ['OAK_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={cliSkillUpdateCommand}']
  ],
  [
  ...
  [
    ...
    ['OAK_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={browserUseUpdateCommand}']
  ],
  [
  ...
  [
    ...
    ['OAK_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
    'src/renderer/src/components/sidebar/LinearAgentSkillSetupPrompt.tsx',
    ['OAK_LINEAR_SKILL_UPDATE_COMMAND', 'installedCommand={installedCommand}']
  ],
  [
