    ...
    <>
      <div className="flex flex-col items-center gap-3 rounded-lg border border-border/60 py-6">
        ...
        <p className="text-muted-foreground max-w-xs text-center text-xs">
          {translate(
            ...
            'Scan this code with the Oak mobile app. Each code creates a unique device token.'
          )}
        </p>
        {pairingUrl && (
      ...
      <Dialog open={qrEnlarged} onOpenChange={onQrEnlargedChange}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            <DialogTitle>
              {translate('auto.components.settings.MobilePane.dd3cd78d04', 'Scan with Oak Mobile')}
            </DialogTitle>
          </DialogHeader>
