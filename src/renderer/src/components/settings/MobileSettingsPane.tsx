...
const OAK_IOS_APP_STORE_URL = 'https://apps.apple.com/app/oak-ide/id6766130217'
const OAK_ANDROID_APK_URL =
  'https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk'
    ...
    <div className="space-y-4">
      ...
      >
        <p className="text-xs text-muted-foreground">
          {translate(
            ...
            'Control Oak from your phone by scanning a QR code. Get the iOS app from the'
          )}{' '}
          <button
            type="button"
            onClick={() => void window.api.shell.openUrl(OAK_IOS_APP_STORE_URL)}
          ...
          <button
            ...
            onClick={() => void window.api.shell.openUrl(OAK_ANDROID_APK_URL)}
            className="cursor-pointer underline underline-offset-2 hover:text-foreground"
          >
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Oak Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Oak Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Oak Mobile shortcut in the sidebar.'
          )}
