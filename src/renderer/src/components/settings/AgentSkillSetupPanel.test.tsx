...
const INSTALL_COMMAND = 'npx skills add https://github.com/e-yc/oak --skill oak-cli --global'
const UPDATE_COMMAND = 'npx skills update oak-cli --global'
...
function panelProps(
  ...
  return {
    title: 'CLI skill',
    description: 'Enables agents to use Oak workflows.',
...
describe('AgentSkillSetupPanel', () => {
  ...
  it('keeps update copy until the installed panel checks CLI prerequisites', () => {
    const html = renderPanel({
      ...
      preInstallNotice: 'Install the Oak CLI before running agent skill setup.'
    })
