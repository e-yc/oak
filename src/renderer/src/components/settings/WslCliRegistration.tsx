...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'oak-ide'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `oak-ide` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Oak itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Oak will register {{value0}} so the command works from WSL terminals.',
