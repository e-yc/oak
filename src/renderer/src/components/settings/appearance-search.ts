...
export const getThemeEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose how Oak looks in the app window.'
    ),
    keywords: [
...
export const getLanguageEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose the language used by the Oak interface.'
    ),
    keywords: [
...
export const getTypographyEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose the font used by the Oak interface.'
    ),
    keywords: [
      ...
      ...translateSearchKeyword('auto.components.settings.appearance.search.1f2880a9d5', 'oak'),
      ...translateSearchKeyword(
...
const getSystemTrayEntryCatalog = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'When enabled, closing the window keeps Oak running in the system tray instead of quitting.'
    ),
    keywords: [
