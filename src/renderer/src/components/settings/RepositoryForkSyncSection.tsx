  ...
  return {
    ...
    description:
      ...
      translate(
        ...
        'Oak could not fast-forward this fork safely.'
      )
  }
}
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When this fork is behind upstream, Oak can safely fast-forward its default branch. Oak skips the update if the branch has local-only commits or conflicts.'
            )}
          </p>
          <p className="text-xs text-muted-foreground">
            {translate(
