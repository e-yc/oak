...
const AGENT_PROMPT =
  'Use the oak-per-workspace-env skill to set up a per-workspace environment for this repo.'
        ...
        <ul className="space-y-2">
          <WhatItem
            text={translate(
              ...
              'Writes the recipe & scripts for your provider — connected over an Oak server or SSH.'
            )}
          />
          <WhatItem
            text={translate(
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Recipes your agent adds to oak.yaml show up here, ready to launch a workspace on.'
              )}
            </p>
          </div>
          <Button
