...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Oak CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Oak CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Oak skill so agents know to use the Oak CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer Oak version.'
    ),
    keywords: [
