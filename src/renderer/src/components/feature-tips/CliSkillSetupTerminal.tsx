...
import { OAK_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND } from '@/lib/agent-feature-install-commands'
import { translate } from '@/i18n/i18n'

export function CliSkillSetupTerminal(): React.JSX.Element {
  const handleCopySkillCommand = async (): Promise<void> => {
    try {
      await window.api.ui.writeClipboardText(OAK_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND)
      toast.success(
        translate(
  ...
  return (
    <div className="min-w-0">
      ...
      <OnboardingInlineCommandTerminal
        command={OAK_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND}
        title={translate(
        ...
        ariaLabel={translate(
          ...
          'Oak CLI and orchestration skill install terminal'
        )}
        description={translate(
          'auto.components.feature.tips.CliSkillSetupTerminal.1953e90447',
          'Press Enter to install the Oak CLI orchestration skill for your agents.'
        )}
