...
describe('SshPtyProvider', () => {
  ...
  describe('spawn', () => {
    ...
    it('injects the relay-backed Oak CLI bridge into remote PTY env', async () => {
      mux.request.mockResolvedValue({ id: 'pty-bridge' })
      provider = new SshPtyProvider('conn-1', mux as never, {
        binDir: '/home/user/.oak-relay/bin',
        relayDir: '/home/user/.oak-relay/relay-v1',
        nodePath: '/usr/bin/node',
        sockPath: '/home/user/.oak-relay/relay.sock'
      })

      await provider.spawn({
        cols: 120,
        rows: 40,
        env: { PATH: '/usr/bin', OAK_TERMINAL_HANDLE: 'term_ssh' }
      })
      ...
      expect(mux.request).toHaveBeenCalledWith('pty.spawn', {
        ...
        cwd: undefined,
        env: {
          PATH: '/home/user/.oak-relay/bin:/usr/bin',
          OAK_TERMINAL_HANDLE: 'term_ssh',
          [POWERLEVEL10K_WIZARD_DISABLE_ENV]: 'true',
          OAK_REMOTE_CLI_BIN_DIR: '/home/user/.oak-relay/bin',
          OAK_RELAY_DIR: '/home/user/.oak-relay/relay-v1',
          OAK_RELAY_NODE_PATH: '/usr/bin/node',
          OAK_RELAY_SOCKET_PATH: '/home/user/.oak-relay/relay.sock'
        }
      })
    })
    ...
    it('uses Windows PATH delimiters for native Windows SSH bridge env', async () => {
      mux.request.mockResolvedValue({ id: 'pty-bridge' })
      provider = new SshPtyProvider('conn-1', mux as never, {
        binDir: 'C:/Users/me/.oak-relay/bin',
        relayDir: 'C:/Users/me/.oak-remote/relay-v1',
        nodePath: 'C:/Program Files/nodejs/node.exe',
        sockPath: '\\\\.\\pipe\\oak-relay-123',
        pathDelimiter: ';'
      })
      ...
      expect(mux.request).toHaveBeenCalledWith('pty.spawn', {
        ...
        cwd: undefined,
        env: {
          Path: 'C:/Users/me/.oak-relay/bin;C:/Windows/System32;C:/Tools',
          [POWERLEVEL10K_WIZARD_DISABLE_ENV]: 'true',
          OAK_REMOTE_CLI_BIN_DIR: 'C:/Users/me/.oak-relay/bin',
          OAK_RELAY_DIR: 'C:/Users/me/.oak-remote/relay-v1',
          OAK_RELAY_NODE_PATH: 'C:/Program Files/nodejs/node.exe',
          OAK_RELAY_SOCKET_PATH: '\\\\.\\pipe\\oak-relay-123'
        }
      })
    })
