...
function getAuthConfig(): BitbucketAuthConfig {
  return {
    baseUrl: envValue('OAK_BITBUCKET_API_BASE_URL') ?? DEFAULT_API_BASE_URL,
    accessToken: envValue('OAK_BITBUCKET_ACCESS_TOKEN'),
    email: envValue('OAK_BITBUCKET_EMAIL'),
    apiToken: envValue('OAK_BITBUCKET_API_TOKEN')
  }
}
