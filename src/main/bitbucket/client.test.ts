...
describe('Bitbucket client', () => {
  beforeEach(() => {
    process.env = { ...OLD_ENV }
    process.env.OAK_BITBUCKET_API_BASE_URL = 'https://api.test.local/2.0'
    process.env.OAK_BITBUCKET_EMAIL = 'user@example.com'
    process.env.OAK_BITBUCKET_API_TOKEN = 'token'
    delete process.env.OAK_BITBUCKET_ACCESS_TOKEN
