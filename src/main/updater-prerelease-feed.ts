...
const ATOM_FEED_URL = 'https://github.com/e-yc/oak/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/e-yc/oak/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/e-yc\/oak\/releases\/tag\/([^"]+)"/g
