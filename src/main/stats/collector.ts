...
// through Oak. Without a cap, a heavily-used instance accumulates thousands of
...
// after configureDevUserDataPath() but before app.setName('Oak'). See the
...
export function initStatsPath(): void {
  _statsFile = join(app.getPath('userData'), 'oak-stats.json')
}
