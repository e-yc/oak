 ...
 * oak-runtime.ts normalizeTerminalChunk but avoids importing the runtime.
 */
...
export class AgentDetector {
  ...
  /**
   * Called on every PTY data chunk (from oak-runtime.ts onPtyData).
  ...
  /**
   * Called when a PTY process exits (from oak-runtime.ts onPtyExit).
   */
