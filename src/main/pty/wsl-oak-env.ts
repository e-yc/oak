...
export function addOakWslInteropEnv(env: Record<string, string>): void {
  ...
  const passthroughEntries = [
    ...
    'OAK_TAB_ID/u',
    'OAK_WORKTREE_ID/u',
    'OAK_AGENT_LAUNCH_TOKEN/u',
    'OAK_AGENT_HOOK_PORT/u',
    'OAK_AGENT_HOOK_TOKEN/u',
    'OAK_AGENT_HOOK_ENV/u',
    'OAK_AGENT_HOOK_VERSION/u',
    'OAK_AGENT_HOOK_ENDPOINT/p',
