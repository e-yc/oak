...
const OAK_CLAUDE_SERVICE = 'Oak Claude Code Managed Credentials'
...
export async function readManagedClaudeKeychainCredentials(
  ...
  return readKeychainPassword(OAK_CLAUDE_SERVICE, accountId)
}
...
export async function writeManagedClaudeKeychainCredentials(
  ...
  await writeKeychainPassword(OAK_CLAUDE_SERVICE, accountId, contents)
}

export async function deleteManagedClaudeKeychainCredentials(accountId: string): Promise<void> {
  await deleteKeychainPassword(OAK_CLAUDE_SERVICE, accountId)
}
