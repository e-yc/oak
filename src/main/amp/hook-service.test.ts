...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'oak-amp-home-'))
  ...
  it('installs an Oak-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.OAK_PANE_KEY')
  ...
  it('removes only Oak-managed Amp plugin files', () => {
