...
describe('listWorkItems', () => {
  ...
  it('marks fork PRs as cross-repository when REST payload only includes head.label', async () => {
    getIssueOwnerRepoMock.mockResolvedValueOnce({ owner: 'stablyai', repo: 'oak' })
    getOwnerRepoMock.mockResolvedValueOnce({ owner: 'stablyai', repo: 'oak' })
      ...
      stdout: JSON.stringify([
        {
          ...
          state: 'open',
          html_url: 'https://github.com/e-yc/oak/pull/1849',
    ...
    expect(items).toEqual([
      {
        ...
        title: 'Fork PR with missing head repo',
        state: 'open',
        url: 'https://github.com/e-yc/oak/pull/1849',
        labels: [],
        updatedAt: '2026-04-01T00:00:00Z',
        author: 'contributor',
        ...
        baseRefName: 'main',
        headSha: 'head-1849',
        prRepo: { owner: 'stablyai', repo: 'oak' },
