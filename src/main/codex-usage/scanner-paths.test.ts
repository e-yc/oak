...
beforeEach(() => {
  ...
  fakeHomeDir = mkdtempSync(join(tmpdir(), 'oak-codex-usage-home-'))
  userDataDir = mkdtempSync(join(tmpdir(), 'oak-codex-usage-user-data-'))
...
describe('getCodexSessionsDirectory', () => {
  it('defaults to Oak-managed Codex runtime sessions', () => {
...
describe('listCodexSessionFiles', () => {
  it('scans both Oak-managed and system Codex session homes', async () => {
