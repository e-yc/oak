...
const OAK_PROJECT_DETAIL_FIELDS = `
  ${OAK_PROJECT_FIELDS}
...
const PROJECTS_QUERY = `
  query OakLinearProjects($first: Int, $filter: ProjectFilter, $orderBy: PaginationOrderBy) {
...
const SEARCH_PROJECTS_QUERY = `
  query OakLinearProjectSearch($term: String!, $first: Int, $after: String) {
...
const PROJECT_QUERY = `
  query OakLinearProject($id: String!) {
    project(id: $id) {
      ${OAK_PROJECT_DETAIL_FIELDS}
    }
  }
`

const CREATE_PROJECT_MUTATION = `
  mutation OakLinearProjectCreate($input: ProjectCreateInput!) {
...
const PROJECT_TEAMS_QUERY = `
  query OakLinearProjectTeams($id: String!, $first: Int, $after: String) {
    project(id: $id) {
...
const CUSTOM_VIEW_QUERY = `
  query OakLinearCustomView($id: String!) {
    customView(id: $id) {
      id
      name
      description
...
const CUSTOM_VIEW_ISSUES_QUERY = `
  query OakLinearCustomViewIssues(
    $id: String!,
    $first: Int,
    $after: String,
    $orderBy: PaginationOrderBy
...
const CUSTOM_VIEW_PROJECTS_QUERY = `
  query OakLinearCustomViewProjects($id: String!, $first: Int, $orderBy: PaginationOrderBy) {
    customView(id: $id) {
      id
      modelName
...
async function readIssueConnectionPages(
  ...
  while (items.length < limit) {
    ...
    // Oak reads must follow cursors to show more than one backend page.
