...
export const ISSUE_QUERY = `
  query OakAgentLinearIssue($id: String!) {
    issue(id: $id) {
      ${ISSUE_FIELDS}
    }
  }
...
export const SEARCH_QUERY = `
  query OakAgentLinearSearch($term: String!, $first: Int) {
...
export const COMMENTS_QUERY = `
  query OakAgentLinearIssueComments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const CHILDREN_QUERY = `
  query OakAgentLinearIssueChildren($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const ATTACHMENTS_QUERY = `
  query OakAgentLinearIssueAttachments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const RELATIONS_QUERY = `
  query OakAgentLinearIssueRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
