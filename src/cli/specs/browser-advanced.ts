...
export const BROWSER_ADVANCED_COMMAND_SPECS: CommandSpec[] = [
  // ── Cookie management ──
  {
    ...
    usage: 'oak cookie get [--url <url>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'oak cookie set --name <n> --value <v> [--domain <d>] [--path <p>] [--secure] [--httpOnly] [--sameSite <s>] [--expires <epoch>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'name',
      'value',
  ...
  },
  {
    ...
    usage:
      'oak cookie delete --name <n> [--domain <d>] [--url <u>] [--worktree <selector>] [--json]',
  ...
  // ── Viewport ──
  {
    ...
    usage:
      'oak viewport --width <w> --height <h> [--scale <n>] [--mobile] [--worktree <selector>] [--json]',
  ...
  // ── Geolocation ──
  {
    ...
    usage:
      'oak geolocation --latitude <lat> --longitude <lon> [--accuracy <n>] [--worktree <selector>] [--json]',
  ...
  // ── Request interception ──
  {
    ...
    usage: 'oak intercept enable [--patterns <glob,...>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'patterns', 'worktree']
  },
  {
    path: ['intercept', 'disable'],
    summary: 'Disable request interception',
    usage: 'oak intercept disable [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['intercept', 'list'],
    summary: 'List paused (intercepted) requests',
    usage: 'oak intercept list [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  ...
  // ── Console/network capture ──
  {
    ...
    usage: 'oak capture start [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['capture', 'stop'],
    summary: 'Stop capturing console and network events',
    usage: 'oak capture stop [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['console'],
    summary: 'Show captured console log entries',
    usage: 'oak console [--limit <n>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'limit', 'worktree']
  },
  {
    path: ['network'],
    summary: 'Show captured network requests',
    usage: 'oak network [--limit <n>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'limit', 'worktree']
  },
  ...
  // ── Keyboard insert text ──
  {
    ...
    usage: 'oak inserttext --text <text> [--worktree <selector>] [--json]',
  ...
  // ── Mouse commands ──
  {
    ...
    usage: 'oak mouse move --x <n> --y <n> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'x', 'y', 'worktree']
  },
  {
    path: ['mouse', 'down'],
    summary: 'Press mouse button',
    usage: 'oak mouse down [--button <left|right|middle>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'button', 'worktree']
  },
  {
    path: ['mouse', 'up'],
    summary: 'Release mouse button',
    usage: 'oak mouse up [--button <left|right|middle>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'button', 'worktree']
  },
  {
    path: ['mouse', 'wheel'],
    summary: 'Scroll wheel',
    usage: 'oak mouse wheel --dy <n> [--dx <n>] [--worktree <selector>] [--json]',
  ...
  // ── Find (semantic locators) ──
  {
    ...
    usage:
      'oak find --locator <type> --value <text> --action <action> [--text <text>] [--worktree <selector>] [--json]',
  ...
  // ── Set commands ──
  {
    ...
    usage: 'oak set device --name <device> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'name', 'worktree']
  },
  {
    path: ['set', 'offline'],
    summary: 'Toggle offline mode',
    usage: 'oak set offline [--state <on|off>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'state', 'worktree']
  },
  {
    path: ['set', 'headers'],
    summary: 'Set extra HTTP headers',
    usage: 'oak set headers --headers <json> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'headers', 'worktree']
  },
  {
    path: ['set', 'credentials'],
    summary: 'Set HTTP auth credentials',
    usage: 'oak set credentials --user <user> --pass <pass> [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'oak set media [--color-scheme <dark|light>] [--reduced-motion <reduce|no-preference>] [--worktree <selector>] [--json]',
  ...
  // ── Clipboard commands ──
  {
    ...
    usage: 'oak clipboard read [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['clipboard', 'write'],
    summary: 'Write text to clipboard',
    usage: 'oak clipboard write --text <text> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'text', 'worktree']
  },
  // ── Dialog commands ──
  {
    ...
    usage: 'oak dialog accept [--text <text>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'text', 'worktree']
  },
  {
    path: ['dialog', 'dismiss'],
    summary: 'Dismiss a browser dialog',
    usage: 'oak dialog dismiss [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  // ── Storage commands ──
  {
  ...
  // ── Download command ──
  {
    ...
    usage: 'oak download --selector <ref> --path <path> [--worktree <selector>] [--json]',
  ...
  // ── Highlight command ──
  {
    ...
    usage: 'oak highlight --selector <ref> [--worktree <selector>] [--json]',
