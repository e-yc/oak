...
export const LINEAR_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: ['oak linear search "auth bug"', 'oak linear search ENG --workspace all --json']
  },
  {
    ...
    examples: ['oak linear team list --workspace all --json']
  },
  {
    ...
    examples: ['oak linear team members --team ENG --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['oak linear team states --team ENG --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['oak linear team labels --team ENG --json']
  },
  {
    ...
    examples: [
      'oak linear project list --query launch --json',
      'oak linear project list --workspace all --json'
    ]
  },
  {
    path: ['linear', 'list'],
    ...
    examples: ['oak linear list --filter assigned --limit 10 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'oak linear status set ENG-123 --to "In Review"',
      'oak linear status set --current --to Done --json'
    ]
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['oak linear assignee set --current --me --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['oak linear assignee clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear priority set --current --to high --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear priority clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear estimate set --current --to 3 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear estimate clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear due-date set --current --to 2026-06-30 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear due-date clear ENG-123 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['oak linear label add --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear label remove --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['oak linear label set ENG-123 --label Bug --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'oak linear comment add ENG-123 --body "Implementation is ready for review."',
  ...
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'oak linear attach ENG-123 --url https://example.com/review/123 --title "PR/MR link"',
      'oak linear attach --current --url https://example.com/review/123 --json'
    ]
  },
  {
    path: ['linear', 'create'],
    ...
    usage:
      'oak linear create --title <title> [--body <text> | --body-file <path|->] [--team <key|id>] [--project <projectId-or-exact-name>] [--state <stateId|exact-name>] [--assignee me|<userId>] [--priority none|low|medium|high|urgent] [--estimate <number>] [--due-date <yyyy-mm-dd>] [--label <labelId-or-exact-name>]... [--parent <id> | --parent-current] [--write-id <uuid>] [--workspace <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'title',
      'body',
    ...
    examples: [
      'oak linear create --title "Investigate flaky login" --team ENG --project "Launch"',
      'oak linear create --title "Follow-up bug" --parent-current --body-file - --json'
    ],
