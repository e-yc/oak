...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Oak runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'oak serve',
      'oak serve --json',
      'oak serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'oak serve --port 6768 --pairing-address 100.64.1.20',
      'oak serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
