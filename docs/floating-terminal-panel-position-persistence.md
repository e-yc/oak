...
1. Add floating panel bounds persistence helpers beside the existing panel bounds math:
   - use a panel-specific versioned key, e.g. `oak-floating-terminal-panel-bounds-v1`;
