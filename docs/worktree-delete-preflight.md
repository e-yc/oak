...
- `removeManagedWorktree` runtime/RPC (`src/main/runtime/oak-runtime.ts`)
...
3. Wire runtime ordering and failure mapping in `src/main/runtime/oak-runtime.ts`; update `src/main/runtime/oak-runtime.test.ts`.
