...
<p align="center">
  <a href="https://github.com/e-yc/oak/stargazers"><img src="https://badgen.net/github/stars/e-yc/oak?label=%E2%98%85" alt="Estrellas en GitHub" /></a>
  <a href="https://github.com/e-yc/oak/releases"><img src="../assets/readme-downloads.svg" alt="Descargas totales en todas las versiones" /></a>
  <img src="https://badgen.net/github/license/e-yc/oak" alt="Licencia" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Únete al Discord de Oak" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Sigue a Oak en X" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>Descargar Oak</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="La app de escritorio de Oak ejecutando agentes en worktrees paralelos, con la app companion móvil de Oak en la esquina" width="960" />
</p>
...
[App Store de iOS](https://apps.apple.com/us/app/oak-ide/id6766130217) · [APK para Android](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk) · [Docs →](https://www.onorca.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Oak de escritorio con la app companion móvil" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Flujos de trabajo de GitHub y Linear en Oak" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Deja comentarios en cualquier línea de un diff y envíalos de vuelta al agente — revisa, edita y haz commit sin salir de Oak.
...
Los agentes también manejan Oak — automatiza cualquier flujo de trabajo con `oak worktree create`, `snapshot`, `click` y `fill`.

[Docs →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/oak-cli.gif" type="image/gif"><img src="../assets/feature-wall/oak-cli.jpg" alt="Automatiza Oak desde la CLI" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **Y muchas, muchas más** — lanzamos a diario, así que esta lista siempre va atrasada. El [changelog](https://github.com/e-yc/oak/releases) es la verdadera lista de funciones.

---

## Agentes compatibles

Funciona con **cualquier agente CLI** — si corre en una terminal, corre en Oak.
...
- O descarga un build directamente: [macOS Apple Silicon](https://github.com/e-yc/oak/releases/latest/download/oak-macos-arm64.dmg) · [macOS Intel](https://github.com/e-yc/oak/releases/latest/download/oak-macos-x64.dmg) · [Windows (.exe)](https://github.com/e-yc/oak/releases/latest/download/oak-windows-setup.exe) · [Linux AppImage](https://github.com/e-yc/oak/releases/latest/download/oak-linux.AppImage) · [Todos los builds](https://github.com/e-yc/oak/releases/latest)
...
- **iOS:** [Descargar desde App Store](https://apps.apple.com/us/app/oak-ide/id6766130217)
- **Android:** [Descargar el APK](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk)
...
- **Feedback e ideas:** Lanzamos rápido. ¿Te falta algo? [Pide una nueva feature](https://github.com/e-yc/oak/issues).
- **Privacidad:** Consulta la [documentación de privacidad y telemetría](https://www.onorca.dev/docs/telemetry) para saber qué datos anónimos de uso recopila Oak y cómo desactivar su envío.
- **Muéstranos tu apoyo:** Dale una [estrella](https://github.com/e-yc/oak) a este repo para seguir nuestros lanzamientos diarios.

---

## Desarrollo

¿Quieres contribuir o ejecutar Oak localmente? Consulta nuestra guía [CONTRIBUTING.md](../../.github/CONTRIBUTING.md).

<a href="https://github.com/e-yc/oak/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=e-yc/oak" alt="Contribuidores de Oak" />
</a>

## Licencia

Oak es libre y de código abierto bajo la [Licencia MIT](../../LICENSE).
