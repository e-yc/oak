...
<p align="center">
  <a href="https://github.com/e-yc/oak/stargazers"><img src="https://badgen.net/github/stars/e-yc/oak?label=%E2%98%85" alt="GitHub スター数" /></a>
  <a href="https://github.com/e-yc/oak/releases"><img src="../assets/readme-downloads.svg" alt="全リリースの合計ダウンロード数" /></a>
  <img src="https://badgen.net/github/license/e-yc/oak" alt="ライセンス" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Oak の Discord に参加" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="X で Oak をフォロー" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>Oak をダウンロード</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="並列ワークツリーでエージェントを実行する Oak デスクトップアプリと、隅に表示された Oak モバイル companion アプリ" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/oak-ide/id6766130217) · [Android APK](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk) · [ドキュメント →](https://www.onorca.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Oak デスクトップとモバイル companion アプリ" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Oak の GitHub と Linear タスクワークフロー" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
任意の Diff 行にコメントを付けてエージェントへ送り返せます — Oak から離れずにレビュー、編集、コミットまで完結します。
...
エージェント自身も Oak を操作できます — `oak worktree create`、`snapshot`、`click`、`fill` であらゆるワークフローをスクリプト化できます。

[ドキュメント →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/oak-cli.gif" type="image/gif"><img src="../assets/feature-wall/oak-cli.jpg" alt="CLI から Oak をスクリプト操作" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **その他、まだまだたくさん** — 毎日リリースしているので、このリストは常に追いついていません。本当の機能一覧は[チェンジログ](https://github.com/e-yc/oak/releases)です。

---

## 対応するエージェント

**あらゆる CLI エージェント**で動作します — ターミナルで動くものなら、Oak でも動きます。
...
- またはビルドを直接入手: [macOS Apple Silicon](https://github.com/e-yc/oak/releases/latest/download/oak-macos-arm64.dmg) · [macOS Intel](https://github.com/e-yc/oak/releases/latest/download/oak-macos-x64.dmg) · [Windows (.exe)](https://github.com/e-yc/oak/releases/latest/download/oak-windows-setup.exe) · [Linux AppImage](https://github.com/e-yc/oak/releases/latest/download/oak-linux.AppImage) · [すべてのビルド](https://github.com/e-yc/oak/releases/latest)
...
- **iOS:** [App Store からダウンロード](https://apps.apple.com/us/app/oak-ide/id6766130217)
- **Android:** [APK をダウンロード](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk)
...
- **フィードバックとアイデア:** 私たちは高速にリリースしています。足りない機能がありますか？[機能リクエストを送信](https://github.com/e-yc/oak/issues)してください。
- **プライバシー:** Oak が収集する匿名の利用データとオプトアウトの方法については、[プライバシーとテレメトリーのドキュメント](https://www.onorca.dev/docs/telemetry)をご覧ください。
- **応援する:** 毎日のリリースを追うために、このリポジトリに[スター](https://github.com/e-yc/oak)を付けてください。
...
<a href="https://github.com/e-yc/oak/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=e-yc/oak" alt="Oak のコントリビューター" />
</a>

## ライセンス

Oak は [MIT License](../../LICENSE) の下で無料かつオープンソースです。
