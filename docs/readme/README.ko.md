...
<p align="center">
  <a href="https://github.com/e-yc/oak/stargazers"><img src="https://badgen.net/github/stars/e-yc/oak?label=%E2%98%85" alt="GitHub 스타" /></a>
  <a href="https://github.com/e-yc/oak/releases"><img src="../assets/readme-downloads.svg" alt="전체 릴리스 누적 다운로드 수" /></a>
  <img src="https://badgen.net/github/license/e-yc/oak" alt="라이선스" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Oak Discord 참여" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="X에서 Oak 팔로우" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>Oak 다운로드</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="병렬 worktree에서 에이전트를 실행 중인 Oak 데스크톱 앱과 한쪽 모서리에 보이는 Oak 모바일 companion 앱" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/oak-ide/id6766130217) · [Android APK](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk) · [문서 →](https://www.onorca.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Oak 데스크톱과 모바일 companion 앱" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Oak의 GitHub 및 Linear 작업 워크플로" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
diff의 어느 줄에든 코멘트를 남기고 에이전트에게 바로 보내세요 — Oak를 떠나지 않고 리뷰하고 수정하고 커밋할 수 있습니다.
...
에이전트도 Oak를 조작할 수 있습니다 — `oak worktree create`, `snapshot`, `click`, `fill`로 모든 워크플로를 스크립팅하세요.

[문서 →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/oak-cli.gif" type="image/gif"><img src="../assets/feature-wall/oak-cli.jpg" alt="CLI에서 Oak 스크립팅" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **그리고 훨씬 더 많은 기능** — 매일 출시하기 때문에 이 목록은 항상 뒤처져 있습니다. 진짜 기능 목록은 [체인지로그](https://github.com/e-yc/oak/releases)입니다.

---

## 지원 에이전트

**모든 CLI 에이전트**와 함께 작동합니다 — 터미널에서 실행되는 에이전트라면 Oak에서도 실행됩니다.
...
- 또는 빌드를 직접 받기: [macOS Apple Silicon](https://github.com/e-yc/oak/releases/latest/download/oak-macos-arm64.dmg) · [macOS Intel](https://github.com/e-yc/oak/releases/latest/download/oak-macos-x64.dmg) · [Windows (.exe)](https://github.com/e-yc/oak/releases/latest/download/oak-windows-setup.exe) · [Linux AppImage](https://github.com/e-yc/oak/releases/latest/download/oak-linux.AppImage) · [전체 빌드](https://github.com/e-yc/oak/releases/latest)
...
- **iOS:** [App Store에서 다운로드](https://apps.apple.com/us/app/oak-ide/id6766130217)
- **Android:** [APK 다운로드](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk)
...
- **피드백과 아이디어:** 우리는 빠르게 출시합니다. 필요한 기능이 있나요? [새 기능을 요청](https://github.com/e-yc/oak/issues)하세요.
- **개인정보 보호:** Oak가 수집하는 익명 사용 데이터와 수집 거부 방법은 [개인정보 및 텔레메트리 문서](https://www.onorca.dev/docs/telemetry)를 참고하세요.
- **응원하기:** 이 리포지토리에 [Star](https://github.com/e-yc/oak)를 눌러 매일의 릴리스를 따라와 주세요.
...
<a href="https://github.com/e-yc/oak/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=e-yc/oak" alt="Oak 기여자" />
</a>

## 라이선스

Oak는 [MIT 라이선스](../../LICENSE)에 따라 자유롭게 사용할 수 있는 오픈 소스입니다.
