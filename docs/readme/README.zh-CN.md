...
<p align="center">
  <a href="https://github.com/e-yc/oak/stargazers"><img src="https://badgen.net/github/stars/e-yc/oak?label=%E2%98%85" alt="GitHub Star 数" /></a>
  <a href="https://github.com/e-yc/oak/releases"><img src="../assets/readme-downloads.svg" alt="所有版本的总下载量" /></a>
  <img src="https://badgen.net/github/license/e-yc/oak" alt="许可证" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="加入 Oak Discord" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="在 X 上关注 Oak" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>下载 Oak</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="Oak 桌面应用在并行 worktree 中运行智能体，角落里是 Oak 移动 companion 应用" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/oak-ide/id6766130217) · [Android APK](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk) · [文档 →](https://www.onorca.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Oak 桌面端与移动 companion 应用" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Oak 中的 GitHub 与 Linear 任务工作流" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
在任意 diff 行上添加评论并发回给智能体 — 评审、编辑、提交，全程无需离开 Oak。
...
智能体也能驱动 Oak — 用 `oak worktree create`、`snapshot`、`click` 和 `fill` 把每个工作流脚本化。

[文档 →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/oak-cli.gif" type="image/gif"><img src="../assets/feature-wall/oak-cli.jpg" alt="从 CLI 脚本化 Oak" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **还有很多很多** — 我们每天发布新功能，这个列表永远跟不上。[更新日志](https://github.com/e-yc/oak/releases)才是真正的功能列表。

---

## 支持的智能体

适配**任何 CLI 智能体** — 只要能在终端里运行，就能在 Oak 里运行。
...
- 或直接获取安装包：[macOS Apple Silicon](https://github.com/e-yc/oak/releases/latest/download/oak-macos-arm64.dmg) · [macOS Intel](https://github.com/e-yc/oak/releases/latest/download/oak-macos-x64.dmg) · [Windows (.exe)](https://github.com/e-yc/oak/releases/latest/download/oak-windows-setup.exe) · [Linux AppImage](https://github.com/e-yc/oak/releases/latest/download/oak-linux.AppImage) · [全部构建](https://github.com/e-yc/oak/releases/latest)
...
- **iOS:** [从 App Store 下载](https://apps.apple.com/us/app/oak-ide/id6766130217)
- **Android:** [下载 APK](https://github.com/e-yc/oak/releases/download/mobile-android-v0.0.18/app-release.apk)
...
- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/e-yc/oak/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.onorca.dev/docs/telemetry)，了解 Oak 收集哪些匿名使用数据以及如何退出。
- **支持我们:** 给这个仓库点 [Star](https://github.com/e-yc/oak)，关注我们的日常发布。
...
<a href="https://github.com/e-yc/oak/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=e-yc/oak" alt="Oak 贡献者" />
</a>

## 许可证

Oak 是自由且开源的软件，遵循 [MIT 许可证](../../LICENSE)。
