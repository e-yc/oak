...
Oak app shortcuts dispatch by logical key by default.
...
1. Oak commands that act on terminal UI, such as copy selection, paste, search, clear,
...
This boundary is intentional. It lets non-US layouts use Oak commands naturally while
