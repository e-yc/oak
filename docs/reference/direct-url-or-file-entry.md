...
1. A URL to open an Oak browser tab.
...
- Do not open external URLs outside Oak.
...
- No active worktree: disable the entry, including URL entry, because Oak browser tabs are worktree-scoped.
