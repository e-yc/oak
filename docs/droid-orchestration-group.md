...
- User sends `oak orchestration send --to @droid ...`.
...
- Manual/CLI: with a Droid terminal title, `oak orchestration send --to @droid --subject ...` should resolve recipients; without one it should report no recipients.
